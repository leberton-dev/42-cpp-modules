...
ClapTrap::ClapTrap ()
: _name ("default"), _hitPoints (CLAPTRAP_HP), _energyPoints (CLAPTRAP_EP), _attackDamage (CLAPTRAP_AD) {
    _logEnterConstructor (_name, "default constructor", BLUE);
}

ClapTrap::ClapTrap (std::string name)
: _name (name.empty () ? "default" : name), _hitPoints (CLAPTRAP_HP), _energyPoints (CLAPTRAP_EP),
  _attackDamage (CLAPTRAP_AD) {
