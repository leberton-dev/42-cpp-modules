...
void ScavTrap::attack (const std::string& target) {
    ...
    if (_energyPoints > 0 && _hitPoints > 0) {
        ...
        _logActionFailed ("attack", "insufficient energy and hit points", GREEN, _name);
    else if (_energyPoints <= 0)
        _logActionFailed ("attack", "insufficient energy points", GREEN, _name);
    else
        _logActionFailed ("attack", "insufficient hit points", GREEN, _name);
}
